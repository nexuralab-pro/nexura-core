...
<body class="bg-gray-900 text-white min-h-screen flex flex-col justify-between">
    ...
    <div class="max-w-md w-full mx-auto p-6 bg-gray-950 border border-gray-800 rounded-2xl shadow-2xl my-12">
    ...
    <div class="w-full max-w-6xl mx-auto h-24 bg-gray-800 mb-6 flex items-center justify-center border border-dashed border-gray-600 text-gray-400 text-xs">
